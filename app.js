...
//app.set("views", path.join(__dirname, "views")); (same below)
...
// const data = {
//   //object value
//   name: "Marley", // {{name}} from hbs file (we just put directly)
//   lastName: "test name",
//   // bootcamp:"<span>Ironhack Web Dev</span>", //{{{}}} escape HTML but still add "HTML"element (e.g,<div></div><)
//   // anotehrObj:{key:"value"}, //possible
//   // anotherArr :[1,2,3,3,4,5] //possible
//   cities: ["Berlin", "Madrid", "Seoul", "Tokyo", "Mumbai"],
...
app.get("/", (req, res) => {
  res.render("index"); // no need to /views/index (you set it above)
});
...
//     res.render("players"); // no need to /views/index (you set it above)
//     });
...
app.get("/team", (req, res) => {
  res.render("teams", { layout: false }); // no need to /views/index (you set it above)
}); // {layout: false} -> skipping layout
